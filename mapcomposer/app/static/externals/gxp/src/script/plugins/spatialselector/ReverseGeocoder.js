...
gxp.plugins.spatialselector.ReverseGeocoder = Ext.extend(gxp.plugins.Tool, {
	...
	locationsGridTitleText: "Locations found",
	locateText: "Locate on map",
	locationFormTitleText: "Location form",
	/** EoF i18n **/
    ...
    addOutput: function() {
	    ...
	    layout.items = [{
			xtype: "fieldset",
			title: this.locationFormTitleText,
			items:[{
	            xtype   : "button",
	            text : this.locateText,
			...
			xtype: "fieldset",
			title: this.locationsGridTitleText,
			items:[{
	            xtype: "grid",
	            layout: "fit",
	            ref: "../featureGrid",
