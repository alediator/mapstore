...
public class SARWindGeneratorService extends GenericActionService implements ActionService<FileSystemEvent, MetocActionConfiguration> {

	public SARWindGeneratorService(String id,
			Class<? extends BaseAction<? extends EventObject>> actionType) {
		super(id, actionType);
		// TODO Auto-generated constructor stub
	}
	
	public SARWindGeneratorService(String id) {
		super(id, SARWindAction.class);
		// TODO Auto-generated constructor stub
	}
